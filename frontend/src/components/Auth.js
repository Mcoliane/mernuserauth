                        ...
                        <Card className="w-[340px] h-[600px] flex flex-col">
                            ...
                            <CardBody className="flex-1 overflow-auto px-4 py-6">
                                <div className="mt-4 min-h-[400px]">
                                    {tab === "login" ? (<Form onSubmit={signIn} className="flex flex-col gap-4">
                                            ...
                                            />
                                            <Button type="submit"
                                                    className="bg-yellow-500 hover:bg-yellow-400 text-black hover:text-white font-bold py-2 px-4 rounded shadow transition">Login</Button>
                                            <Button onPress={signInWithGoogle}
                                                    className="bg-blue-600 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded shadow transition">Sign
                                                in with Google</Button>
                                        </Form>) : (<Form onSubmit={signUp} className="flex flex-col gap-4">
                                            ...
                                            />
                                            <Button type="submit"
                                                    className="bg-yellow-500 hover:bg-yellow-400 text-black hover:text-white font-bold py-2 px-4 rounded shadow transition">Sign
                                                Up</Button>
                                        </Form>)}
                                </div>
                            </CardBody>
