        ...
        >
            ...
            <NavbarContent className="hidden sm:flex gap-4" justify="center">
                ...
                <Dropdown>
                    ...
                    >
                        ...
                        <DropdownItem key="Rules" description="Timed blitz matches">
                            <Link
                                color="foreground"
                                href="/howToPlay"
                                className="hover:text-yellow-600 transition-colors duration-300 font-medium"
                ...
                <NavbarItem>
                    <Link href="/protected" className="hover:text-yellow-600 transition-colors">
                        Protected
                    </Link>
                </NavbarItem>
            ...
            <NavbarContent as="div" justify="end">
                <Dropdown placement="bottom-end">
                    ...
                    <DropdownMenu aria-label="Profile Actions" variant="flat" className="bg-white border border-gray-200 shadow-lg rounded-lg p-2" itemClasses={{
                        base: "rounded-md px-4 py-3 hover:bg-yellow-100 hover:text-black transition duration-300",
                    }}>
